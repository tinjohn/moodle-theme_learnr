...
class core_renderer extends \theme_boost\output\core_renderer {
    ...
    public function courseprogressbar() {
        ...
        if (\core_completion\progress::get_course_progress_percentage($PAGE->course)) {
            ...
            $completedmods = progresscount::get_course_progress_completedmods($PAGE->course);
        ...
        $progresschartcontext = ['progress' => $comppercent, 'progresscnt' => $comppcnt, 'completedmods' => $completedmods, 'hasprogressbar' => $hasprogressbar];
